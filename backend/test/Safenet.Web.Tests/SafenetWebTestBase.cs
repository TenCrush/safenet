...
{
    public abstract class SafenetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SafenetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SafenetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SafenetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SafenetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SafenetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SafenetDbContext, Task<T>> func)
        {
            T result;
